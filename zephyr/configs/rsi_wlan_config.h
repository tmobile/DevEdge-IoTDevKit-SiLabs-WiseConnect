...
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP (RSI_ECFBM_TLS_CONFIG | EXT_FEAT_LOW_POWER_MODE | BIT(31))
...
#if CONFIG_WISECONNECT_ROAMING_SUPPORT
#define RSI_ROAMING_SUPPORT RSI_ENABLE
#endif

#ifdef CONFIG_WISECONNECT_ROAMING_THRESHOLD
#define RSI_ROAMING_THRESHOLD CONFIG_WISECONNECT_ROAMING_THRESHOLD
#endif

#ifdef CONFIG_WISECONNECT_ROAMING_HYSTERISIS
#define RSI_ROAMING_HYSTERISIS CONFIG_WISECONNECT_ROAMING_HYSTERISIS
#endif
